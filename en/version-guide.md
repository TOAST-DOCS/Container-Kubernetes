...
| v1.29.3 | May 2024 | 2026.02.28 | 2026.02.28 |
...
|------|------------|--------------------|-----|
| 1.202505.0 | November 2025 | v1.28–v1.32 | Indicates a cluster that has not had a platform version applied. |
| 1.202511.0 | November 2025 | v1.28–v1.33 | Initial platform version release |
| 1.202511.1 | December 2025 | v1.28–v1.33 | Fixed an issue where the health check port configuration was incorrect. |
| 1.202602.0 | February 2026 | v1.29–v1.33 | Added Features<br>- Kubernetes taint configuration <br>- Support for Kubernetes component configuration for max-pods <br>- Support for etcd data encryption with Secure Key Manager <br>- Support for CGroup v2 OS image<br><br>Feature Updates<br>- Support for improved traffic handling during node and node group deletion |
| 1.202602.1 | March 2026 | v1.29–v1.33 | Improved<br>- Enhanced stability of LBs created with Service objects |
| 1.202605.0 | May 2026 | v1.30–v1.34 | Feature Updates<br>- Added support for worker node CGroup v1 → v2 migration<br>- Enabled the `ImageVolume` feature gate for Kubernetes v1.34 clusters<br>- Added support for konnectivity for communication between kube-apiserver and pods<br>- Added support for etcd upgrades |
