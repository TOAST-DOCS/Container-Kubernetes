...
* Added support for Kubernetes v1.34.3.
    * In k8s v1.34 and later, there are constraints based on the CGroup version of worker node images. For more information, see [Constraints by Kubernetes Version and CGroup Version](/Container/NKS/en/version-guide/#constraints-on-cgroup).
...
* Added 1.202605.0
    ...
    * Added Features
        * Added support for worker node CGroup migration from v1 to v2
...
#### Platform Version Updates
* Added 1.202602.0
    * Compatible Kubernetes versions: v1.29–v1.33
    * Added Features
...
#### Added Features
* Added support for OS images with CGroup configured as v2.
    * OS images released after March 2026 are configured with CGroup v2.
* Added support for configuring kubelet's --max-pods using the Kubernetes component configuration feature.
* Added the Kubernetes taint configuration feature.
* Added support for encrypting and decrypting confidential cluster data using the Secure Key Manager service.
...
* Added a feature to store logs of Kubernetes control plane components.
