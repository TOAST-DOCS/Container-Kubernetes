...
* Added 1.202608.0
    * Compatible Kubernetes versions: v1.31–v1.35
...
* Added support for Kubernetes v1.34.3.
    * In k8s v1.34 and later versions, there are constraints depending on the CGroup version of the worker node image. For more information, see [Constraints by Kubernetes Version and CGroup Version](/Container/NKS/en/version-guide/#constraints-on-cgroup).
    * In k8s v1.34 and later versions, the custom containerd registry settings feature does not work. For more information, see [Custom containerd Registry Settings Feature](/Container/NKS/en/version-guide/#containerd-registry-config).
...
* Added 1.202605.0
    ...
    * Added Features
        * Support for worker node CGroup v1 → v2 migration
        * Support for konnectivity for communication between kube-apiserver and pods
...
#### Added Features
* Added support for OS images with CGroup set to v2.
    * OS images released after March 2026 have CGroup set to v2.
* You can use the Kubernetes component configuration feature to set `--max-pods` for kubelet.
* Added the Kubernetes taint configuration feature.
* You can encrypt and decrypt confidential data in the cluster by using the Secure Key Manager service.
...
#### Platform Version Updates
* Added 1.202511.1
    * Fixed an issue with the health check port configuration.
...
* Added the feature to view and upgrade the platform version of control planes and worker node groups.
* Added the feature to set the health check port as setting detailed options for load balancer.
* Added the feature to set the health check host header as setting detailed options for load balancer.
...
* Added the feature to store logs of Kubernetes control plane components.
...
* Addon management feature is available.
    * For more information, see the [User Guide](/Container/NKS/en/user-guide/#addon-mgmt).
...
#### Added Features
* The Public API for Kubernetes service has been released.
...
#### Added Features
* GPU-based node groups are now available in Kubernetes clusters.
    * Image updates
