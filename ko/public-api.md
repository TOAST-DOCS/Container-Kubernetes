...
| labels.ncr_sgw | Body | String | X | NCR 타입의 서비스 게이트웨이 UUID |
| labels.obs_sgw | Body | String | X | OBS 타입의 서비스 게이트웨이 UUID |
...
IP 접근 제어 기능에 대한 자세한 사항은 [IP 접근제어](/Network/Load%20Balancer/ko/overview/#ip)문서 참고하시고
