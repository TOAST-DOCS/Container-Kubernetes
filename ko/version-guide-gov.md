...
| v1.35 | 2026.08 | 2027.10.30 | 2028.08.31 |
...
| 1.202602.0 | 2026.02 | v1.29–v1.33 | 기능 추가<br>- Kubernetes 테인트 설정 기능 <br>- Kubernetes 컴포넌트 설정 기능 max-pods 설정 지원 <br>- Secure Key Manager를 이용한 etcd 데이터 암호화 지원 <br>- CGroup v2 OS 이미지 지원<br><br>기능 개선<br>- 노드 및 노드 그룹 삭제 시 로드 밸런서 트래픽 유실 개선<br>- Service 객체로 생성된 LB의 안정성 강화 |
